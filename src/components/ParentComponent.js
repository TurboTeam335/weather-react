...
const ParentComponent = ({ weatherData, setWeatherData }) => {
  ...
  return (
    <Box padding={2}>
      ...
      <Card sx={{ flex: '0 0 48%', padding: 2, background: 'transparent', boxShadow: 'none', borderRight: '1px solid white', borderRadius: '0' }}>
          <WeatherCard weatherData={weatherData} temperatureUnit={temperatureUnit} /> {/* Pass temperatureUnit if needed */}
        </Card>
        <Card sx={{ flex: '0 0 48%', padding: 2, background: 'transparent', boxShadow: 'none', }}>
